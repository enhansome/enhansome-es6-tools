...
* [Babel](https://github.com/babel/babel) ⭐ 43,987 | 🐛 779 | 🌐 TypeScript | 📅 2026-08-31 - Turn ES6+ code into vanilla ES5 with no runtime
...
* [Lebab](https://github.com/mohebifar/lebab) ⭐ 5,636 | 🐛 39 | 🌐 JavaScript | 📅 2026-04-01 - Transformations for ES5 code to ES6 (approximates)
...
* [core-js](https://github.com/zloirock/core-js) ⭐ 25,525 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-02 - Modular and compact polyfills for ES6 including Symbols, Map, Set, Iterators, Promises, setImmediate, Array generics, etc. The standard library used by [Babel](https://github.com/babel/babel) ⭐ 43,987 | 🐛 779 | 🌐 TypeScript | 📅 2026-08-31.
...
* [Esprima](http://esprima.org) - JavaScript parser supporting ES6, parses to [ESTree AST format](https://github.com/estree/estree) ⭐ 5,431 | 🐛 44 | 📅 2026-05-01
