...
* [Babel](https://github.com/babel/babel) ⭐ 43,988 | 🐛 778 | 🌐 TypeScript | 📅 2026-08-31 - Turn ES6+ code into vanilla ES5 with no runtime
...
* [core-js](https://github.com/zloirock/core-js) ⭐ 25,527 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-01 - Modular and compact polyfills for ES6 including Symbols, Map, Set, Iterators, Promises, setImmediate, Array generics, etc. The standard library used by [Babel](https://github.com/babel/babel) ⭐ 43,988 | 🐛 778 | 🌐 TypeScript | 📅 2026-08-31.
...
* [Esprima](http://esprima.org) - JavaScript parser supporting ES6, parses to [ESTree AST format](https://github.com/estree/estree) ⭐ 5,430 | 🐛 44 | 📅 2026-05-01
