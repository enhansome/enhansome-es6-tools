...
* [Babel](https://github.com/babel/babel) ⭐ 44,031 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-26 - Turn ES6+ code into vanilla ES5 with no runtime
...
* Babel: [babel-loader](https://github.com/babel/babel-loader) ⭐ 4,834 | 🐛 67 | 🌐 JavaScript | 📅 2026-09-03
...
* [Babel Module Loader](https://github.com/babel/babel-loader) ⭐ 4,834 | 🐛 67 | 🌐 JavaScript | 📅 2026-09-03
...
* [core-js](https://github.com/zloirock/core-js) ⭐ 25,536 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-26 - Modular and compact polyfills for ES6 including Symbols, Map, Set, Iterators, Promises, setImmediate, Array generics, etc. The standard library used by [Babel](https://github.com/babel/babel) ⭐ 44,031 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-26.
...
* [Acorn](https://github.com/ternjs/acorn) ⭐ 11,451 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-16 - A small, fast, JavaScript-based JavaScript parser with ES6 support, parses to [SpiderMonkey AST](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/SpiderMonkey/Parser_API) format.
