...
* [Babel](https://github.com/babel/babel) ⭐ 44,013 | 🐛 769 | 🌐 TypeScript | 📅 2026-09-18 - Turn ES6+ code into vanilla ES5 with no runtime
...
* [core-js](https://github.com/zloirock/core-js) ⭐ 25,538 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-24 - Modular and compact polyfills for ES6 including Symbols, Map, Set, Iterators, Promises, setImmediate, Array generics, etc. The standard library used by [Babel](https://github.com/babel/babel) ⭐ 44,013 | 🐛 769 | 🌐 TypeScript | 📅 2026-09-18.
...
* [Acorn](https://github.com/ternjs/acorn) ⭐ 11,453 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-16 - A small, fast, JavaScript-based JavaScript parser with ES6 support, parses to [SpiderMonkey AST](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/SpiderMonkey/Parser_API) format.
